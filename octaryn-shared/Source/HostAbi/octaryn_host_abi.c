...
_Static_assert(sizeof(octaryn_chunk_column_request_frame) == OCTARYN_CHUNK_COLUMN_REQUEST_FRAME_SIZE, "octaryn_chunk_column_request_frame ABI size mismatch");
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, version, 0u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, size, 4u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, center_chunk_x, 8u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, center_chunk_z, 12u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, radius, 16u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, column_capacity, 20u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, block_capacity, 24u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, column_count, 28u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, block_count, 32u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, status, 36u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, columns_address, 40u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_request_frame, blocks_address, 48u);
_Static_assert(sizeof(octaryn_chunk_column_snapshot_column) == OCTARYN_CHUNK_COLUMN_SNAPSHOT_COLUMN_SIZE, "octaryn_chunk_column_snapshot_column ABI size mismatch");
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_column, version, 0u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_column, size, 4u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_column, chunk_x, 8u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_column, chunk_z, 12u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_column, origin_x, 16u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_column, origin_z, 20u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_column, block_offset, 24u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_column, block_count, 28u);
_Static_assert(sizeof(octaryn_chunk_column_snapshot_block) == OCTARYN_CHUNK_COLUMN_SNAPSHOT_BLOCK_SIZE, "octaryn_chunk_column_snapshot_block ABI size mismatch");
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_block, version, 0u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_block, size, 4u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_block, x, 8u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_block, y, 12u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_block, z, 16u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_block, block, 20u);
OCTARYN_ASSERT_OFFSET(octaryn_chunk_column_snapshot_block, reserved, 22u);
