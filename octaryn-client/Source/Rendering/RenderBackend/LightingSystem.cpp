...
void apply_quality(WorldRenderer& r) {
  ...
  r.local_lighting.settings.debug=r.lighting_settings.debug_view>=13?r.lighting_settings.debug_view-12:0;
}
}
...
bool initialize_lighting(WorldRenderer& r) {
  ...
  apply_quality(r);
  if(!initialize_rt_shadows(r) || !world_ray_debug_initialize(r) || !initialize_shadow_fallback(r) || !world_ddgi_initialize(r) || !world_local_lighting_initialize(r))return false;
