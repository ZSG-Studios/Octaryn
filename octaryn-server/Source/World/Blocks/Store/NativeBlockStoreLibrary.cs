...
internal static unsafe class NativeBlockStoreLibrary
{
    ...
    public static readonly delegate* unmanaged[Cdecl]<IntPtr, NativeBlockPosition*, delegate* unmanaged[Cdecl]<void*, NativeBlockPosition*, ushort>, void*, ushort> BlockEditServiceGetBlock;
    ...
    public static readonly delegate* unmanaged[Cdecl]<IntPtr, IntPtr, HostCommand*, delegate* unmanaged[Cdecl]<void*, NativeBlockPosition*, ushort>, delegate* unmanaged[Cdecl]<void*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, NativeBlockEdit*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, ushort, NativeBlockPosition*, ushort, uint>, void*, NativeBlockEdit*, uint, uint*, NativeBlockEditResult> BlockEditServiceApplyCommandAndEnqueue;
    ...
    public static readonly delegate* unmanaged[Cdecl]<IntPtr, IntPtr, IntPtr, delegate* unmanaged[Cdecl]<void*, NativeBlockPosition*, ushort>, delegate* unmanaged[Cdecl]<void*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, NativeBlockEdit*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, ushort, NativeBlockPosition*, ushort, uint>, void*, delegate* unmanaged[Cdecl]<void*, HostCommand*, NativeBlockEditResult*, NativeBlockEdit*, uint, uint>, void*, int> ClientBlockCommandQueueDrainApplyAndEnqueue;
    public static readonly delegate* unmanaged[Cdecl]<IntPtr, IntPtr, IntPtr, delegate* unmanaged[Cdecl]<void*, NativeBlockPosition*, ushort>, delegate* unmanaged[Cdecl]<void*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, NativeBlockEdit*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, ushort, NativeBlockPosition*, ushort, uint>, void*, delegate* unmanaged[Cdecl]<void*, HostCommand*, NativeBlockEditResult*, NativeBlockEdit*, uint, uint>, void*, NativeClientBlockCommandDrainReport*, int> ClientBlockCommandQueueDrainApplyAndEnqueueReport;
    ...
    public static readonly delegate* unmanaged[Cdecl]<uint, byte*> ClientBlockCommandSubmitReasonName;
    ...
    public static readonly delegate* unmanaged[Cdecl]<IntPtr, NativeChunkViewIntent*, uint, uint, uint, NativeChunkStreamProcessStagePlan*, int> ChunkStreamPlanProcessStage;
    public static readonly delegate* unmanaged[Cdecl]<NativeChunkStreamProcessTickDecision*, HostFrameSnapshot*, delegate* unmanaged[Cdecl]<void*, HostFrameSnapshot*, int>, delegate* unmanaged[Cdecl]<void*, HostFrameSnapshot*, int>, void*, int> ChunkStreamExecuteProcessTick;
    ...
    static NativeBlockStoreLibrary()
    {
        ...
        BlockEditServiceGetBlock = (delegate* unmanaged[Cdecl]<IntPtr, NativeBlockPosition*, delegate* unmanaged[Cdecl]<void*, NativeBlockPosition*, ushort>, void*, ushort>)Export(library, "octaryn_server_block_edit_service_get_block");
        ...
        BlockEditServiceApplyCommandAndEnqueue = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr, HostCommand*, delegate* unmanaged[Cdecl]<void*, NativeBlockPosition*, ushort>, delegate* unmanaged[Cdecl]<void*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, NativeBlockEdit*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, ushort, NativeBlockPosition*, ushort, uint>, void*, NativeBlockEdit*, uint, uint*, NativeBlockEditResult>)Export(library, "octaryn_server_block_edit_service_apply_command_and_enqueue");
        ...
        ClientBlockCommandQueueDrainApplyAndEnqueue = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr, IntPtr, delegate* unmanaged[Cdecl]<void*, NativeBlockPosition*, ushort>, delegate* unmanaged[Cdecl]<void*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, NativeBlockEdit*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, ushort, NativeBlockPosition*, ushort, uint>, void*, delegate* unmanaged[Cdecl]<void*, HostCommand*, NativeBlockEditResult*, NativeBlockEdit*, uint, uint>, void*, int>)Export(library, "octaryn_server_client_block_command_queue_drain_apply_and_enqueue");
        ClientBlockCommandQueueDrainApplyAndEnqueueReport = (delegate* unmanaged[Cdecl]<IntPtr, IntPtr, IntPtr, delegate* unmanaged[Cdecl]<void*, NativeBlockPosition*, ushort>, delegate* unmanaged[Cdecl]<void*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, NativeBlockEdit*, ushort, uint>, delegate* unmanaged[Cdecl]<void*, ushort, NativeBlockPosition*, ushort, uint>, void*, delegate* unmanaged[Cdecl]<void*, HostCommand*, NativeBlockEditResult*, NativeBlockEdit*, uint, uint>, void*, NativeClientBlockCommandDrainReport*, int>)Export(library, "octaryn_server_client_block_command_queue_drain_apply_and_enqueue_report");
        ...
        ClientBlockCommandSubmitReasonName = (delegate* unmanaged[Cdecl]<uint, byte*>)Export(library, "octaryn_server_client_block_command_submit_reason_name");
        ...
        ChunkStreamPlanProcessStage = (delegate* unmanaged[Cdecl]<IntPtr, NativeChunkViewIntent*, uint, uint, uint, NativeChunkStreamProcessStagePlan*, int>)Export(library, "octaryn_server_chunk_stream_plan_process_stage");
        ChunkStreamExecuteProcessTick = (delegate* unmanaged[Cdecl]<NativeChunkStreamProcessTickDecision*, HostFrameSnapshot*, delegate* unmanaged[Cdecl]<void*, HostFrameSnapshot*, int>, delegate* unmanaged[Cdecl]<void*, HostFrameSnapshot*, int>, void*, int>)Export(library, "octaryn_server_chunk_stream_execute_process_tick");
    ...
    public static string ClientBlockCommandSubmitReasonLabel(NativeClientBlockCommandSubmitReason reason)
    {
        return Marshal.PtrToStringUTF8((IntPtr)ClientBlockCommandSubmitReasonName((uint)reason)) ?? "native_submit";
    }

    public static bool IsHostCommandCurrent(HostCommand command)
    {
        return HostCommandIsCurrent(&command) != 0;
    }
