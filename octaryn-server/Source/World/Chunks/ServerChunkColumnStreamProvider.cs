...
internal sealed class ServerChunkColumnStreamProvider
{
    private readonly ServerBlockStore _blocks;
    ...
    public ServerChunkColumnStreamProvider(
        ServerBlockStore blocks,
        ServerTerrainGenerator? terrainGenerator,
        ServerNativeEmptyWorldGenerator? nativeEmptyWorldGenerator)
    {
        _blocks = blocks;
    ...
    public ServerChunkColumnStream CaptureChunkColumns(
        int centerChunkX,
        int centerChunkZ,
        uint radius,
        ulong windowEpoch,
