...
#else
#define OCTARYN_SERVER_PLAYER_SIMULATION_API __attribute__((visibility("default")))
#endif

extern "C" {

using octaryn_server_player_block_query_fn =
    uint32_t (*)(void *context, int32_t x, int32_t y, int32_t z);
