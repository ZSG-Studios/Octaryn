...
The Windows build of the 2026-09-14 Slang RHI preview is a native x64 client package with its
...
The experimental Fedora 44 Linux package has a separate [native packaging guide](../build/linux-packaging.md). Publish both game archives, both corresponding relink archives and their checksums. Each platform needs its own qualification.
