...
glass/water/lava, selection, tone mapping, RmlUi and presentation. See [pipeline-parity.md](pipeline-parity.md)
...
1. Reconnect original atlas/material contracts and animated textures, with source
   references and captured runtime evidence. The integrated runtime is covered by the pipeline report.
