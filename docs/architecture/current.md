...
pipeline. The display output is SDR; ray tracing is unfinished.
...
static checks, CPU logic, GPU execution and package verification. Native Linux
and Metal GPU execution need their own evidence; Windows results do not establish
