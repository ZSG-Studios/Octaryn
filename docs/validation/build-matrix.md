...
- Server block-store native validation includes `octaryn_server_block_store_probe`, a C++ probe that validates centered world bounds, floor chunk/local mapping, override edits, preserved air overrides, deterministic snapshots, chunk-column snapshots, load semantics, and generated-override cleanup.
