...
if(NOT DEFINED ENV{VSCMD_ARG_TGT_ARCH})
    message(FATAL_ERROR "Native Windows builds require the Visual Studio developer environment. Use tools/build/windows.ps1.")
endif()
...
find_program(OCTARYN_NATIVE_CLANG_CL NAMES clang-cl HINTS "${octaryn_llvm_bin}" REQUIRED)
