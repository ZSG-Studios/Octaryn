...
internal static class StoreValidation
{
    public static void Validate()
    {
        ...
        ProbeAssertions.Require(first.Chunk == new ClientPresentationChunkKey(0, 0, 0), "first update chunk");
        ...
        ProbeAssertions.Require(second.Chunk == new ClientPresentationChunkKey(-1, 0, -2), "negative block uses floor chunk coordinates");
        ...
        ProbeAssertions.Require(initialDirty.Contains(new ClientPresentationChunkKey(0, 0, -2)), "drain includes negative x border chunk");
        ProbeAssertions.Require(initialDirty.Contains(new ClientPresentationChunkKey(-1, 0, -1)), "drain includes negative z border chunk");
        ...
        ProbeAssertions.Require(borderDirty.Contains(new ClientPresentationChunkKey(0, 0, 0)), "border edit marks owner chunk");
        ProbeAssertions.Require(borderDirty.Contains(new ClientPresentationChunkKey(1, 0, 0)), "border edit marks east chunk");
        ProbeAssertions.Require(borderDirty.Contains(new ClientPresentationChunkKey(0, 0, -1)), "border edit marks north chunk");
        ...
        ProbeAssertions.Require(verticalDirty.Contains(new ClientPresentationChunkKey(0, 0, 0)), "vertical border marks owner section");
        ProbeAssertions.Require(verticalDirty.Contains(new ClientPresentationChunkKey(0, -1, 0)), "vertical border marks lower section");
        ...
        ProbeAssertions.Require(bottomDirty.Contains(new ClientPresentationChunkKey(0, ClientPresentationChunkKey.MinSectionY, 0)), "world bottom marks owner section");
        ...
        ProbeAssertions.Require(topDirty.Contains(new ClientPresentationChunkKey(0, ClientPresentationChunkKey.MaxSectionYExclusive - 1, 0)), "world top marks owner section");
